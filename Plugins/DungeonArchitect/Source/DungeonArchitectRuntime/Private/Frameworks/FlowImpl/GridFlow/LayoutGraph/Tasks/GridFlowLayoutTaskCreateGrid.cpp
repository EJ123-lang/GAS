...
void UGridFlowLayoutTaskCreateGrid::Execute(const FFlowExecutionInput& Input, const FFlowTaskExecutionSettings& InExecSettings, FFlowExecutionOutput& Output) const {
    ...
    CreateGraph(Graph, FIntVector(GridSize.X, GridSize.Y, 1), NegationVolumeContext);
...
void UGridFlowLayoutTaskCreateGrid::CreateGraph(UFlowAbstractGraphBase* InGraph, const FIntVector& InGridSize, const FNegationVolumeContext& InNegationVolumeContext) {
