...
#if 0  // Disabled: Automation test flags not compatible with UE 5.7
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSnapGridFlowResolveTest, "DungeonArchitectTests.SnapGridFlow.Resolve", EAutomationTestFlags::ProductFilter)
