...
#if 0  // Disabled: Uses unsupported automation test flags in UE 5.7
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FDungeonCanvasViewportTransformTest, "DungeonArchitectTests.DungeonCanvasViewportTransform.WorldToCanvasLocation", EAutomationTestFlags::ProductFilter)
