...
// (implementation follows - guarded at end of file)
...
void FDAViewportClient::Draw(FViewport* InViewport, FCanvas* Canvas)
{
	...
	// Remove temporary debug lines - debug drawing is handled automatically in newer engine versions
	// Newer engine versions no longer expose LineBatcher/ForegroundLineBatcher on UWorld.
