...
void FDungeonCanvasEditor::CompileImpl() {
...
void FDungeonCanvasEditor::UpdateCDOReferences() const {
	const UDungeonCanvasBlueprint* CanvasBlueprint = Cast<UDungeonCanvasBlueprint>(GetBlueprintObj());
	UDungeonCanvasBlueprintGeneratedClass* CanvasGeneratedClass = Cast<UDungeonCanvasBlueprintGeneratedClass>(GetBlueprintObj()->GeneratedClass);
	if (CanvasBlueprint && CanvasGeneratedClass) {
		// Copy over the material instance
		CanvasGeneratedClass->MaterialInstance = CanvasBlueprint->MaterialInstance;

		// Copy over the material layers, recreating them on the generated class
		CanvasGeneratedClass->MaterialLayers.Reset();
		for (UDungeonCanvasMaterialLayer* SourceMaterialLayer : CanvasBlueprint->MaterialLayers) {
			if (SourceMaterialLayer) {
				UDungeonCanvasMaterialLayer* MaterialLayerCopy = NewObject<UDungeonCanvasMaterialLayer>(CanvasGeneratedClass, NAME_None, RF_NoFlags, SourceMaterialLayer);
				CanvasGeneratedClass->MaterialLayers.Add(MaterialLayerCopy);
			}
		}
